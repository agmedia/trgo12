{{-- Flat Rate modal --}}
<div class="modal fade" id="shipping-modal-flat" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content rounded-3">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title">{{ __('back/shop/shipping/flat.title') }}</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-10 mx-auto">
                        ...
                        {{-- Title (multi-lang pills) --}}
                        @include('back.settings.partials.lang-title', ['code'  => 'flat', 'label' => __('back/shop/shipping/flat.input_title')])

                        <div class="row g-3">
                            <div class="col-md-4">
                                <label class="form-label">{{ __('back/shop/shipping/flat.rate_amount') }}</label>
                                <input type="text" class="form-control" data-config="price" data-default="0">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">{{ __('back/shop/shipping/flat.free_over') }}</label>
                                <input type="text" class="form-control" data-config="free_over">
                            </div>
                            <div class="col-md-4">
                        ...
                        @include('back.settings.partials.lang-description', ['code'  => 'flat'])
            ...
            <div class="modal-footer bg-light">
                ...
                <button class="btn btn-primary" onclick="saveShipping('flat');">{{ __('back/shop/shipping.save') }}</button>
            </div>
        </div>
    </div>
</div>
